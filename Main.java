...
public class Main {
    ...
    public static void interpretator(String command) {
        ...
        """);
            ...
            default:
                // Проверяем, не команда ли это из модуля
    ...
    private static void loadModule(String jarPath, String className) {
        try {
            ...
            if (!jarFile.isAbsolute()) {
                // Делаем путь относительно текущей рабочей директории
            ...
            e.printStackTrace(); // Добавь эту строку чтобы увидеть детали ошибки
        }
    }
    ...
    // === ОСТАЛЬНЫЕ МЕТОДЫ (оставить как есть) ===
